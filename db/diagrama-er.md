...
erDiagram
    ...
    PHISHING_CORPORATE_PAGES ||--o{ PHISHING_CAMPAIGNS : "ingenieria social pasiva"
    ...
    PHISHING_CAMPAIGNS {
        ...
        VARCHAR2_36 CREATED_BY FK
        VARCHAR2_36 CORPORATE_PAGE_ID FK
        TIMESTAMP CREATED_AT
        TIMESTAMP UPDATED_AT
    }

    PHISHING_CORPORATE_PAGES {
        VARCHAR2_36 ID PK
        VARCHAR2_255 NAME
        VARCHAR2_500 REAL_URL
        VARCHAR2_500 LOOKALIKE_URL
        NUMBER_1 IS_ACTIVE
        VARCHAR2_36 CREATED_BY FK
        TIMESTAMP CREATED_AT
        TIMESTAMP UPDATED_AT
